...
require (
	github.com/Traceableai/agent-config/gen/go v0.0.0-20220209211231-51b2f4efb6ae // indirect
	...
	github.com/hypertrace/agent-config/gen/go v0.0.0-20220209183558-95cc7dcabb51 // indirect
	github.com/hypertrace/goagent v0.5.1 // indirect
